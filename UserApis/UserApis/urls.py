"""
URL configuration for UserApis project.
...
urlpatterns = [
    ...
    path('password_reset/',views.PasswordResetApi.as_view(), name='password_reset'),
    path('password_reset/<uidb64>/<token>/',views.PasswordResetConfirmApi.as_view(), name='password_reset_confirm'),
